...
<main class="px-16">
<body class="font-sans bg-gray-900 text-white mb-3">
    <nav class="border-b border-gray-800">
        ...
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
            <ul class="flex flex-col md:flex-row itmes-center">
                ...
                <li class="md:ml-6 mt-3 md:mt-0">
                    <a href="{{route('posts.index')}}" class="hover:text-gray-300">Blog</a>
                </li>

                <li class="md:ml-6 mt-3 md:mt-0">
                    <a href="{{route('posts.create')}}" class="hover:text-gray-300">Create Post</a>
                </li>
            </ul>
