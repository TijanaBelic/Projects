...
@section('content')
    ...
    <div class="movie-info border-b border-gray-800">
        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <img src="{{ 'https://image.tmdb.org/t/p/w500/' . $movie['poster_path'] }}" alt="image not available" class="w-64 lg:w-96">
                    ...
                    <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                        <div class="bg-gray-900 rounded">
                           ...
                           <div class="modal-body px-8 py-8">
                               <div class="responsive-containter overflow-hidden relative" style="
                                     padding-top: 56.25%">
                                     <iframe width="560" height="315" class="responsive-iframe absolute
                                      top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/{{ $movie['videos']['results'][0]['key'] }}" style="border:0;"
